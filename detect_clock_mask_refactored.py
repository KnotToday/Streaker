...
class DetectionViewer:
    ...
    def initialize_viewer_window(self):
        ...
        self.viewer_window.title("Detection Viewer")
        self.canvas = tk.Canvas(self.viewer_window, width=700, height=700)
    ...
    def setup_gui(self):
        ...
        tk.Scale(self.control_window, from_=25, to=220, variable=self.diff_thresh, orient=tk.HORIZONTAL).grid(row=2, column=1, columnspan=4, sticky="ew")
