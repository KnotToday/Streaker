...
# Function to calculate satellite separation
...
tk.Label(root, text="Year:").grid(row=4, column=0, padx=5, pady=5, sticky="e")
...
tk.Label(root, text="Hour (UTC):").grid(row=7, column=0, padx=5, pady=5, sticky="e")
