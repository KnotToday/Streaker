...
def calculate_ra_dec_separation():
    try:
        ...
        range1 = float(range1) if alt_or_range1 == "Range" else EARTH_RADIUS + float(alt1)
        range2 = float(range2) if alt_or_range2 == "Range" else EARTH_RADIUS + float(alt2)
...
tle_calculate_button = tk.Button(tle_tab, text="Calculate Separation", command=calculate_tle_separation)
