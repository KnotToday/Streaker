...
angular_diameter_label.grid(row=2, column=0, columnspan=4, pady=10)

relative_size_label = tk.Label(root, text="Relative to Moon: --%")
relative_size_label.grid(row=3, column=0, columnspan=4, pady=10)

# Matplotlib Figure for Virtual Sky
fig, ax = plt.subplots(figsize=(5, 5))
canvas = FigureCanvasTkAgg(fig, master=root)
canvas_widget = canvas.get_tk_widget()
canvas_widget.grid(row=4, column=0, columnspan=4, pady=10)
