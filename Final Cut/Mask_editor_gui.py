...
class MaskEditor:
    def __init__(self, root):
        ...
        Button(controls_frame, text="Grab Frame from MKV", command=self.grab_mkv_frame).pack(pady=2)
    ...
    def grab_mkv_frame(self):
        ...
        frame_num = simpledialog.askinteger(
            "Frame Number",
            f"Enter frame number to grab (0 – {total - 1}):",
            initialvalue=0, minvalue=0, maxvalue=max(0, total - 1))
